...
Процедура ПриСозданииНаСервере(Форма, Знач ПараметрыРазмещения = Неопределено) Экспорт
	...
	//+++Бауэр Татьяна, 15.06.2026, Дополнить формы: Справочник ДоговорыКонтрагентов - реквизитами 
	//	период действия договора, сумму абоненсткой платы и стоимость часа;
	//  Документ РеализацияТоваровУслуг - кнопкой Заполнить.
	ВКМ_РаботаСФормами.ДополнитьФорму(Форма);
	//---Бауэр Татьяна, 15.06.2026
